...
export type IconGlyph =
  ...
  | 'eye' | 'eye-off' | 'facebook' | 'feather' | 'file' | 'filter'
  | 'folder' | 'gear' | 'gift' | 'globe' | 'google' | 'heart' | 'help'
  | 'home' | 'image' | 'info' | 'instagram' | 'italic' | 'key' | 'layers'
  | 'link' | 'linkedin' | 'location' | 'lock' | 'log-in' | 'log-out'
  ...
  | 'thumbs-down' | 'thumbs-up' | 'tiktok' | 'trash' | 'truck'
  | 'universal-access' | 'unlock' | 'upload' | 'user' | 'users' | 'video'
  | 'wallet' | 'whatsapp' | 'x-circle' | 'x-twitter' | 'youtube' | 'zap'
...
export type IconAlias =
  ...
  | 'comment' | 'message' | 'chat' | 'ai' | 'magic' | 'printer' | 'twitter'
