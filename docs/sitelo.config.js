export default {
   ...
   * different copy, so their scores track the English ones — and ten
   * locales is ten times the browser time for the same findings.
   *
  ...
  lighthouse: {
    ...
    exclude: [
      '{de,es,fr,it,pl,pt,ru,tr,zh}.html',
      '{de,es,fr,it,pl,pt,ru,tr,zh}/**',
      '404.html',
    ],
    /*
