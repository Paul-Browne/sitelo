...
export default () =>
  ...
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Exporté en JSON.', 'success')" }, 'En JSON'),
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Exporté en CSV.', 'success')" }, 'En CSV'),
)`),
