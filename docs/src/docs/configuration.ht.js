  ...
  docsLayout({
    ...
    children: [
      ...
      p(
        ...
        '. Rolldown otherwise reports that plugin hooks dominate the build, which on a sitelo site is always true — generating the pages is the build — so it names the same plugin on every run. Set it to ',
        code('true'),
        ' under ',
        code('vite'),
        ' when profiling your own plugins.',
      ),
      ...
      ul(
        ...
        li(code('sample'), ' — audit this many random pages per ', code('include'), ' pattern instead of all of them'),
        ...
        li(code('formFactor'), ' — ', code("'mobile'"), ' (default), ', code("'desktop'"), ', or both'),
