...
export default () =>
  ...
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Exportado como JSON.', 'success')" }, 'Como JSON'),
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Exportado como CSV.', 'success')" }, 'Como CSV'),
)`),
