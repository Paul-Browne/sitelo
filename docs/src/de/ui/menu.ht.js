...
export default () =>
  ...
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Als JSON exportiert.', 'success')" }, 'Als JSON'),
  menuItem({ onclick: "window.siteloUiToast && window.siteloUiToast('Als CSV exportiert.', 'success')" }, 'Als CSV'),
)`),
