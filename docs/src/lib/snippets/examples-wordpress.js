...
const T = {
  ...
  pt: {
    wpHelpers: 'auxiliares da REST do WP (extração paginada)',
    homeComment: 'início — lista os artigos mais recentes',
    archiveComment: '/blog — arquivo completo',
    everyPost: '/blog/:slug — todos os artigos',
    raiseConcurrency: 'milhares de páginas? aumenta a concorrência',
    wpMax: 'máximo do WP para /wp/v2/posts',
    walkEvery: 'Percorre todas as páginas de /posts até extrair o site inteiro.',
    fullArchive: 'Arquivo completo — pagina por todo o site WP',
    ripping: 'a extrair artigos…',
    sinceStart: 'desde o arranque',
    ripEvery: 'Extrai todos os artigos publicados (milhares não são problema — 100 por pedido)',
    slugsOnly: 'apenas slugs; salta _embed por velocidade',
    page: 'página',
    posts: 'artigos',
    ripped: 'extraídos',
    inTime: 'em',
    mySite: 'O meu site',
    latestFromBlog: 'Últimas do blogue',
  ...
  it: {
    wpHelpers: 'helper REST di WP (scarico paginato)',
    homeComment: 'home — elenca gli ultimi articoli',
    archiveComment: '/blog — archivio completo',
    everyPost: '/blog/:slug — ogni articolo',
    raiseConcurrency: 'migliaia di pagine? alza la concorrenza',
    wpMax: 'massimo di WP per /wp/v2/posts',
    walkEvery: 'Percorri ogni pagina di /posts finché il sito non è scaricato del tutto.',
    fullArchive: 'Archivio completo — pagina attraverso tutto il sito WP',
    ripping: 'scarico articoli…',
    sinceStart: 'dall’inizio',
    ripEvery: 'Scarica ogni articolo pubblicato (migliaia vanno bene — 100 per richiesta)',
    slugsOnly: 'solo slug; salta _embed per velocità',
    page: 'pagina',
    posts: 'articoli',
    ripped: 'scaricati',
    inTime: 'in',
  ...
  tr: {
    wpHelpers: 'WP REST yardımcıları (sayfalı çekim)',
    homeComment: 'ana sayfa — son yazıları listele',
    archiveComment: '/blog — tam arşiv',
    everyPost: '/blog/:slug — her yazı',
    raiseConcurrency: 'binlerce sayfa mı? eşzamanlılığı artır',
    wpMax: '/wp/v2/posts için WP üst sınırı',
    walkEvery: 'Site tamamen çekilene dek /posts’un her sayfasında yürü.',
    fullArchive: 'Tam arşiv — tüm WP sitesinde sayfa sayfa ilerle',
    ripping: 'yazılar çekiliyor…',
    sinceStart: 'başlangıçtan beri',
    ripEvery: 'Yayımlanmış her yazıyı çek (binlercesi sorun değil — istek başına 100)',
    slugsOnly: 'yalnızca slug; hız için _embed’i atla',
    page: 'sayfa',
    posts: 'yazı',
    ripped: 'çekildi',
    inTime: 'süre:',
    mySite: 'Sitem',
    latestFromBlog: 'Blogdan son çıkanlar',
  ...
  id: {
    wpHelpers: 'pembantu REST WP (unduh bertahap)',
    homeComment: 'beranda — daftar tulisan terbaru',
    archiveComment: '/blog — arsip lengkap',
    everyPost: '/blog/:slug — setiap tulisan',
    raiseConcurrency: 'ribuan halaman? naikkan konkurensi',
    wpMax: 'batas WP untuk /wp/v2/posts',
    walkEvery: 'Telusuri setiap halaman /posts sampai seluruh situs terunduh.',
    fullArchive: 'Arsip lengkap — telusuri seluruh situs WP halaman demi halaman',
    ripping: 'mengunduh tulisan…',
    sinceStart: 'sejak mulai',
    ripEvery: 'Unduh setiap tulisan terbit (ribuan pun tidak masalah — 100 per permintaan)',
    slugsOnly: 'slug saja; lewati _embed demi kecepatan',
    page: 'halaman',
    posts: 'tulisan',
    ripped: 'terunduh',
    inTime: 'dalam',
