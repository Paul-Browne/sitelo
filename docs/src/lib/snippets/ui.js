...
const T = {
  ...
  pl: {
    mySite: 'Moja strona',
    hello: 'Cześć',
    leadCopy: 'Strona zbudowana z komponentów.',
    readDocs: 'Przeczytaj dokumentację',
    routing: 'Routing',
    fileBased: 'Oparty na plikach',
    becomesAbout: 'src/about.ht.js staje się /about.',
    readMore: 'Czytaj dalej',
    inlineComment: 'cały arkusz w stronie — żadnego żądania',
    pruneKeepComment: 'albo wskaż klasy, których build nigdy nie widzi; `*` dla prefiksu',
    themingComment: 'Po styles(), więc te wygrywają.',
    themeScriptComment: 'stosuje zapisany wybór przed pierwszym malowaniem',
    anywhereComment: '…gdziekolwiek w body',
    email: 'E-mail',
    neverShared: 'Nigdy nieudostępniany.',
    site: 'Strona',
    notAUrl: 'To nie jest URL.',
    plan: 'Plan',
    free: 'Darmowy',
    pro: 'Pro',
    save: 'Zapisz',
    deleteEllipsis: 'Usuń…',
    deletePage: 'Usunąć tę stronę?',
    deleteWord: 'Usuń',
    cannotUndo: 'Tego nie da się cofnąć.',
    linkTabsComment: 'Zakładki-odnośniki: jedna strona na zakładkę, bez skryptu.',
    panelTabsComment: 'Zakładki-panele: podmiana w miejscu, na grupie radio i CSS.',
  ...
  tr: {
    mySite: 'Sitem',
    hello: 'Merhaba',
    leadCopy: 'Bileşenlerden kurulmuş bir sayfa.',
    readDocs: 'Belgeleri oku',
    routing: 'Yönlendirme',
    fileBased: 'Dosya tabanlı',
    becomesAbout: 'src/about.ht.js /about olur.',
    readMore: 'Devamını oku',
    inlineComment: 'tüm stil sayfası sayfanın içinde — hiç istek yok',
    pruneKeepComment: 'ya da derlemenin hiç görmediği sınıfları yaz; önek için `*`',
    themingComment: 'styles() sonrası, böylece bunlar kazanır.',
    themeScriptComment: 'kayıtlı seçimi ilk boyamadan önce uygular',
    anywhereComment: '…body içinde herhangi bir yerde',
    email: 'E-posta',
    neverShared: 'Asla paylaşılmaz.',
    site: 'Site',
    notAUrl: 'Bir URL değil.',
    plan: 'Plan',
    free: 'Ücretsiz',
    pro: 'Pro',
    save: 'Kaydet',
    deleteEllipsis: 'Sil…',
    deletePage: 'Bu sayfa silinsin mi?',
    deleteWord: 'Sil',
    cannotUndo: 'Bu geri alınamaz.',
    linkTabsComment: 'Bağlantı sekmeleri: sekme başına bir sayfa, hiç script yok.',
    panelTabsComment: 'Panel sekmeleri: yerinde değişir, bir radyo grubu ve CSS ile.',
    docsLabel: 'Belgeler',
    ...
    sizeCol: 'Boyut',
    statusCol: 'Durum',
    failedWord: 'başarısız',
  },
  id: {
    mySite: 'Situs saya',
    hello: 'Halo',
    leadCopy: 'Halaman yang dibangun dari komponen.',
    readDocs: 'Baca dokumentasi',
    routing: 'Perutean',
    fileBased: 'Berbasis berkas',
    becomesAbout: 'src/about.ht.js menjadi /about.',
    readMore: 'Baca selengkapnya',
    inlineComment: 'seluruh lembar gaya di dalam halaman — tanpa permintaan sama sekali',
    pruneKeepComment: 'atau sebutkan kelas yang tak pernah dilihat build; `*` untuk awalan',
    themingComment: 'Setelah styles(), jadi yang ini menang.',
    themeScriptComment: 'menerapkan pilihan tersimpan sebelum cat pertama',
    anywhereComment: '…di mana saja dalam body',
    email: 'Email',
    neverShared: 'Tidak pernah dibagikan.',
    site: 'Situs',
    notAUrl: 'Bukan URL.',
    plan: 'Paket',
    free: 'Gratis',
    pro: 'Pro',
    save: 'Simpan',
    deleteEllipsis: 'Hapus…',
    deletePage: 'Hapus halaman ini?',
    deleteWord: 'Hapus',
    cannotUndo: 'Ini tidak bisa dibatalkan.',
    linkTabsComment: 'Tab tautan: satu halaman per tab, tanpa skrip sama sekali.',
    panelTabsComment: 'Tab panel: bertukar di tempat, dengan grup radio dan CSS.',
