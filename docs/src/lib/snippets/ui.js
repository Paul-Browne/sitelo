...
const T = {
  en: {
    ...
    panelTabsComment: 'Panel tabs: swap in place, on a radio group and CSS.',
    docsLabel: 'Docs',
  ...
  es: {
    ...
    panelTabsComment: 'Pestañas con panel: cambian en el sitio, con un grupo de radios y CSS.',
    docsLabel: 'Docs',
  ...
  fr: {
    ...
    panelTabsComment: 'Onglets à panneaux : échange sur place, avec un groupe de radios et du CSS.',
    docsLabel: 'Docs',
  ...
  de: {
    ...
    panelTabsComment: 'Panel-Tabs: wechseln an Ort und Stelle, per Radiogruppe und CSS.',
    docsLabel: 'Docs',
  ...
  ru: {
    ...
    panelTabsComment: 'Вкладки с панелями: переключаются на месте, на группе радиокнопок и CSS.',
  ...
  zh: {
    ...
    panelTabsComment: '面板式标签页：就地切换，靠一组单选按钮和 CSS。',
    docsLabel: '文档',
    installLabel: '安装',
    useLabel: '使用',
    pageCol: '页面',
  ...
  pt: {
    ...
    panelTabsComment: 'Separadores com painel: trocam no lugar, com um grupo de rádios e CSS.',
    docsLabel: 'Docs',
    installLabel: 'Instalar',
    useLabel: 'Usar',
    pageCol: 'Página',
  ...
  it: {
    mySite: 'Il mio sito',
    hello: 'Ciao',
    leadCopy: 'Una pagina costruita con i componenti.',
    readDocs: 'Leggi la documentazione',
    routing: 'Routing',
    fileBased: 'Basato sui file',
    becomesAbout: 'src/about.ht.js diventa /about.',
    readMore: 'Leggi di più',
    inlineComment: 'tutto il foglio di stile nella pagina — nessuna richiesta',
    pruneKeepComment: 'oppure indica classi che la build non vede mai; `*` per un prefisso',
    themingComment: 'Dopo styles(), così vincono queste.',
    themeScriptComment: 'applica la scelta salvata prima del primo paint',
    anywhereComment: '…in qualunque punto del body',
    email: 'Email',
    neverShared: 'Mai condivisa.',
    site: 'Sito',
    notAUrl: 'Non è un URL.',
    plan: 'Piano',
    free: 'Gratuito',
    pro: 'Pro',
    save: 'Salva',
    deleteEllipsis: 'Elimina…',
    deletePage: 'Eliminare questa pagina?',
    deleteWord: 'Elimina',
    cannotUndo: 'L’operazione non può essere annullata.',
    linkTabsComment: 'Schede-link: una pagina per scheda, nessuno script.',
    panelTabsComment: 'Schede-pannello: scambio sul posto, con un gruppo di radio e CSS.',
